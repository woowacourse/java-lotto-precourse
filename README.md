...
이 문제를 해결하기 위해 Googling을 하였고, 어떤 블로그[^RGRC]에서 RGRC 라는 TDD 개발 단계를 제시하는 것을 발견했습니다. RGRC 는 
...
[^lotto_img]: 출처: https://lottogame.tistory.com/35
[^RGRC]: 출처: https://ardalis.com/rgrc-is-the-new-red-green-refactor-for-test-first-development
